...
class Test(unittest.TestCase):
    ...
    def test_(self):
        ...
        configuration1 = rp.make_configuration_fcc(nx= 8, ny= 8, nz=8,  rho=0.8442, T=1.44)  
        configuration2 = rp.make_configuration_fcc(nx= 5, ny= 5, nz=13, rho=1.2000, T=0.44)  
        configuration3 = rp.make_configuration_fcc(nx=16, ny=16, nz=32, rho=0.8442, T=2.44)  
