...
class PairPotentialWithModifier(Interaction):
    ...
    def __init__(self, pairpotential_function, modifier, params, max_num_nbs, exclusions=None):
        ...
        self.modified_pairpotential_function = self.modifier.modified_potential(self.pairpotential_function)
    ...
    def convert_user_params(self):
        ...
        for i in range(num_types):
            for j in range(num_types):
                ...
                plist = self.modifier.modified_params(self.pairpotential_function, plist)
                if i==0 and j==0:
                    num_params = len(plist)
    ...
    def evaluate_potential_function(self, r, types):
        ...
        u, s, lap = self.modified_pairpotential_function(r, params[types[0], types[1]])
        return u
    ...
    def get_kernel(self, configuration: gp.Configuration, compute_plan: dict, compute_flags: dict[str,bool], verbose=False):
        ...
        pairpotential_function = numba.njit(self.modified_pairpotential_function)
