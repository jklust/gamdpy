...
temperature = rp.make_function_ramp(value0=Tinitial, x0=0.25*running_time, value1=Tfinal, x1=0.75*running_time)
...
dynamics = rp.tools.calc_dynamics(sim.output, first_block=int(sim.num_blocks*3/4), qvalues=7.5*rho**(1/3))
