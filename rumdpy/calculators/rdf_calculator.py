...
class RDF_calculator():
    ...
    def __init__(self, configuration, num_bins, compute_plan=None) -> None:
        ...
        self.count =  0 # How many times have statististics been added to?

        self.compute_plan = compute_plan
        if self.compute_plan==None:
    ...
    def read(self):
        ...
        min_box_dim = min(self.configuration.simbox.lengths[0], self.configuration.simbox.lengths[1], self.configuration.simbox.lengths[2])
